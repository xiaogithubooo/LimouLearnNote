...
>   补充：这里还额外补充一些二叉树的相关题目，这些题目在以前`C`学习中没有过多提及，这是因为采用`C`写会比较痛苦，因此我放在这里供您练习。
>
>   1.   [力扣606. 根据二叉树创建字符串](https://leetcode.cn/problems/construct-string-from-binary-tree/)
>   1.   [力扣102. 二叉树的层序遍历](https://leetcode.cn/problems/binary-tree-level-order-traversal/)
>   1.   [力扣107. 二叉树的层序遍历 II](https://leetcode.cn/problems/binary-tree-level-order-traversal-ii/)
>   1.   [力扣236. 二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)
>   1.   [力扣LCR 155. 将二叉搜索树转化为排序的双向链表](https://leetcode.cn/problems/er-cha-sou-suo-shu-yu-shuang-xiang-lian-biao-lcof/)
