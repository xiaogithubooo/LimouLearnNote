...
但是我们还有一个问题，我们的实现只能`delete`一个指针资源，但是无法完全释放数组一类的资源，这个时候就需要一个删除器。

![image-20231209093737641](./assets/image-20231209093737641.png)

![image-20231209094019164](./assets/image-20231209094019164.png)

![image-20231209094236118](./assets/image-20231209094236118.png)

![image-20231209094609031](./assets/image-20231209094609031.png)

但是这个地方有一个困难没有解决，就是析构没有办法拿到调用函数，但是如果变成成员变量就拿不到类型，因此我们可以使用包装类。

![image-20231209094827964](./assets/image-20231209094827964.png)

![image-20231209094941316](./assets/image-20231209094941316.png)

并且还需要给一个缺省值，防止用户没有传递可调用对象。

![image-20231209095623723](./assets/image-20231209095623723.png)
