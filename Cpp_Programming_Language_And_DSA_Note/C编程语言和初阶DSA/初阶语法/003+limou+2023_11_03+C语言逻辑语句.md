...
>   需求：根据用户给定的两个数，得到最小公约数。

<span style="text-emphasis:filled red;">辗转相除法，待补充...</span>

## 5.5.求解两个数的最大公因数

>   需求：根据用户给定的两个数，得到最打公因数。
...
5.1.关于C语言控制语句笔记的修改和一些代码题目的复习（寻找素数、重新以现有知识水平理解scanf的输入逻辑并且在Linux环境下进行验证）
