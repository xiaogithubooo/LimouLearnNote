...
producer_thread_1 & producer_thread_2 & producer_thread_3 --->|"Put"| BlockingQueue --->|"Take"| consumer_thread_1 & consumer_thread_2 & consumer_thread_3
```
...
生产者的数据不一定是自己出来，也有可能是从网路中来，会花费很多请求和处理时间，而消费者拿到数据也不是立马就可以用的，有可能需要花时间处理数据。因此效率是体现在一些例如：
