...
>   注意：之后尝试使用组件的代码和测试 `Ajax` 请求的代码我都打包为压缩包放在了网盘中
>
>   -   您可以前往 Google 云盘中进行解压
>   -   也可以前往百度网盘中进行解压
...
然后在 `index.js` 中，引入以下代码即可，这段可以在 [ElementUI 官方文档-安装和快速上手](https://element.eleme.cn/#/zh-CN/component/quickstart) 中查阅到。

```js
// 在 index.js 中引入 ElementUI 框架
import Vue from 'vue'
import App from './App.vue'
import router from './router'
